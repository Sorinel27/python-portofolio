...
def right_choice():
    ...
    ro = ro_words[random_index]
    en = en_words[random_index]
    label_word.config(text=ro_words[0])
...
def change_card():
    ...
    label_word.config(text=en, bg=BACKGROUND_COLOR)
    label_language.config(text="English", bg=BACKGROUND_COLOR)
...
label_word = Label(text="apus", font=("Ariel", 60, "bold"), bg="white")
